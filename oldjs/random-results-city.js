/**
 * Random Before & After Results Script - City Pages
 * 城市页面专用：每次刷新随机显示8张不同的案例图片
...
(function() {
    ...
    var descriptions = [
        ...
        { title: 'Crown & Mid-Scalp Recovery', time: '12 months after surgery' },
        ...
        { title: 'Beard Density Enhancement', time: '9 months after surgery' },
        { title: 'Eyebrow Shape Restoration', time: '7 months after surgery' },
        { title: 'Female Hairline Refinement', time: '8 months after surgery' },
        { title: 'Crown Baldness Treatment', time: '11 months after surgery' }
    ];
    ...
    function detectBasePath() {
        ...
        for (var i = 0; i < scripts.length; i++) {
            ...
            if (rawSrc.indexOf('random-results-city.js') !== -1) {
                if (rawSrc.indexOf('../') !== -1) {
                    basePath = '../';
                } else {
                    basePath = '';
    ...
    function setRandomResults() {
        ...
        for (var i = 0; i < 8 && i < resultItems.length; i++) {
            ...
            if (img) img.src = basePath + selected[i];
