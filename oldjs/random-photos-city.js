/**
 * Random Doctor-Patient Photos Script - City Pages
 * 城市页面专用：每次刷新随机显示8张不同的医患合影
 * 图片来源：Photos(1-76)
 */
...
(function() {
    ...
    function detectBasePath() {
        ...
        for (var i = 0; i < scripts.length; i++) {
            ...
            if (rawSrc.indexOf('random-photos-city.js') !== -1) {
                if (rawSrc.indexOf('../') !== -1) {
                    basePath = '../';
                } else {
                    basePath = '';
    ...
    function setRandomPhotos() {
        ...
        for (var i = 0; i < 8 && i < photoItems.length; i++) {
            ...
            if (img) img.src = basePath + 'Photos/Photos-' + selectedPhotos[i] + '.jpg';
